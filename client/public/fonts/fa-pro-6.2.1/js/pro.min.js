!(function () {
  ...
  J.autoFetchSvg &&
    ...
    J.fetchSvgFrom &&
      (((dt = g.createElement("a")).href = J.fetchSvgFrom),
      (J.fetchSvgFrom = dt.href)),
    !J.autoFetchSvg ||
      J.fetchSvgFrom ||
      F ||
      (console.error(
    ...
    Z.autoAddCss &&
      ...
      ((function (t) {
        if (t && w) {
          ...
          for (
            var e = g.head.childNodes, n = null, i = e.length - 1;
            -1 < i;
            i--
          ) {
            var r = e[i],
  ...
  w &&
    ((gt = (g.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(
      g.readyState,
    )) ||
            ...
            n && i && !e && !f
              ...
              : n && e && !i
                ...
                : n &&
                  ...
                  e &&
                  f &&
                  (o = -1 < e.indexOf("primary") ? [i, n] : [n, i]))
          : c && 2 === c.length && (o = c[1]),
        (r =
          s && o ? [parseInt(s[1], 10), parseInt(s[2], 10), [], null, o] : r));
  ...
  function Bt() {
    ...
    (Yt = a.names),
      (Tt = a.unicodes),
      (Rt = $t(Z.styleDefault, { family: Z.familyDefault }));
  }
  function Gt(t, a) {
    return (It[t] || {})[a];
  }
  ...
  function Qt(t, a) {
    ...
    return (
      ...
      a.prefix ||
        ...
        ((a.prefix = "fass"),
        (a.iconName = Xt(a.prefix, a.iconName) || a.iconName)),
  ...
  function ra(t) {
    ...
    if (a)
      return (
        (a = Xt(t, a) || a), kt(oa.definitions, t, a) || kt(vt.styles, t, a)
      );
  }
  var oa = new d(),
    sa = {
      ...
      parse: {
        icon: function (t) {
          ...
          if (
            "string" == typeof t &&
            (-1 < t.indexOf("".concat(Z.cssPrefix, "-")) || t.match(W))
          ) {
            a = Qt(t.split(" "), { skipLookups: !0 });
            return {
              prefix: a.prefix || Rt,
              iconName: Xt(a.prefix, a.iconName) || a.iconName,
            };
          }
          return "string" == typeof t
            ? { prefix: Rt, iconName: Xt(Rt, t) || t }
            : void 0;
        },
      },
      library: oa,
    ...
    d && (p.attributes[O] = ""),
      c &&
        (p.children.push({
          tag: "title",
          attributes: {
            id: p.attributes["aria-labelledby"] || "title-".concat(l || it()),
          },
          children: [c],
        }),
    ...
    return (
      ...
      s
        ? ((b = (v = t).prefix),
          ...
          (v =
            !0 === (v = v.symbol)
              ? "".concat(b, "-").concat(Z.cssPrefix, "-").concat(g)
              : v),
          [
            {
              tag: "svg",
  ...
  function ba(i, r) {
    ...
    return (
      ...
      new Promise(function (a, t) {
        ...
        if (
          ("fa" === o &&
            ((n = Kt(i) || {}), (i = n.iconName || i), (r = n.prefix || r)),
          i && r && ma[r] && ma[r][i])
        ) {
          var e = ma[r][i];
          return a(da(e));
          ...
          return (function (e, n) {
            ...
            return (
              ...
              new Promise(function (a, t) {
                ...
                if (
                  (s && (t = "".concat(t, "?token=").concat(s)),
                  vt.styles[e] && vt.styles[e][n])
                )
        ...
        va(i, r),
          a(
            k(
              ...
              {
                icon:
                  (Z.showMissingIcons && i && ia("missingIconAbstract")) || {},
              },
            ),
          );
      })
  ...
  var ya =
      Z.measurePerformance && c && c.mark && c.measure
        ? c
        : { mark: ga, measure: ga },
    ka = 'FA "6.2.0"',
    wa = {
    ...
    replace: function (t) {
      ...
      a.parentNode &&
        ...
        null === a.getAttribute(O) && Z.keepOriginalSource
          ? ((t = g.createComment(" ".concat(a.outerHTML, " "))),
      ...
      delete e[0].attributes.id,
        e[0].attributes.class &&
          ((t = e[0].attributes.class.split(" ").reduce(
            function (t, a) {
              return (
                (a === Z.replacementClass || a.match(n)
                  ? t.toSvg
                  : t.toNode
                ).push(a),
                t
  ...
  function Ca(e, t) {
    ...
    0 === e.length
      ? n()
      : (Z.mutateApproach === z ? b.requestAnimationFrame || Pa : Pa)(
          function () {
            var t =
                (!0 !== Z.autoReplaceSvg && Na[Z.autoReplaceSvg]) || Na.replace,
              a = wa.begin("mutate");
            e.map(t), a(), n();
          },
        );
      ...
      (i.iconName && i.prefix) ||
        (i.prefix &&
          ...
          (i.iconName =
            ((e = i.prefix),
            (n = t.innerText),
            (Lt[e] || {})[n] || Gt(i.prefix, At(t.innerText)))),
        !i.iconName &&
          Z.autoFetchSvg &&
          t.firstChild &&
      ...
      f && "none" !== u && "" !== u
        ? ((a = c.getPropertyValue("content")),
          ...
          (u = (a =
            ...
            (c = Wa[0] <= l && l <= Wa[1]),
            {
              value: At((l = 2 === u.length && u[0] === u[1]) ? u[0] : u),
              isSecondary: c || l,
            })).value),
          (c = a.isSecondary),
    ...
    (p = [
      ...
      },
      {
        provides: function (t) {
          var r = !1;
          b.matchMedia &&
            (r = b.matchMedia("(prefers-reduced-motion: reduce)").matches),
